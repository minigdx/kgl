...
class KglJogl(private val gl: GL) : Kgl {
    ...
    override fun getAttribLocation(
        programId: Program,
        name: String,
    ): Int = gl.glGetAttribLocation(programId, name)
    ...
    override fun deleteVertexArray(vertexArrayObject: VertexArrayObject) = gl.glDeleteVertexArrays(1, intArrayOf(vertexArrayObject), 0)
