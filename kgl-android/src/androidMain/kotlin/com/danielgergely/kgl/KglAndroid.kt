...
object KglAndroid : Kgl {
    ...
    override fun bindVertexArray(vertexArrayObject: VertexArrayObject?) = GLES30.glBindVertexArray(vertexArrayObject ?: 0)

    override fun deleteVertexArray(vertexArrayObject: VertexArrayObject) = GLES30.glDeleteVertexArrays(1, intArrayOf(vertexArrayObject), 0)
